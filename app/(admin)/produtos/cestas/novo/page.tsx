...
import { createCestas, updateCestas } from '@/actions/cestas'
    ...
    <div className="space-y-5">
      <div className="rounded-2xl bg-brand-red p-5 text-white flex items-center gap-4">
        ...
        <div>
          ...
          <h1 className="text-xl font-bold">Nova cesta</h1>
        </div>
      </div>

      <div className="bg-white rounded-xl border border-border p-5">
        <ProductLineForm basePath="/produtos/cestas" onSave={createCestas} onUpdate={updateCestas} />
      </div>
    </div>
  )
}
