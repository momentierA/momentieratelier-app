...
import { createBBW, updateBBW } from '@/actions/bbw'

export default function NovoBBWPage() {
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white rounded-xl border border-border p-5">
        <ProductLineForm basePath="/produtos/bbw" onSave={createBBW} onUpdate={updateBBW} />
      </div>
    </div>
  )
}
